...
UI_ShowContextMenu!: alias function! [
	this [this!]
	dwID [integer!]
	ppt [POINT!]
...
UI_GetHostInfo!: alias function! [
	this [this!] 
	pInfo [int-ptr!] ;DOCHOSTUIINFO __RPC_FAR *
	return: [integer!]
]
UI_ShowUI!: alias function! [
	this [this!]
	dwID [integer!]
...
UI_HideUI!: alias function! [this [this!] return: [integer!]]
UI_UpdateUI!: alias function! [this [this!] return: [integer!]]
UI_EnableModeless!: alias function! [this [this!] fEnable [logic!] return: [integer!]]
UI_OnDocWindowActivate!: alias function! [this [this!] fActivate [logic!] return: [integer!]]
UI_OnFrameWindowActivate!: alias function! [this [this!] fActivate [logic!] return: [integer!]]
UI_ResizeBorder!: alias function! [
	this [this!]
	prcBorder [LPCRECT!]
...
UI_TranslateAccelerator!: alias function! [
	this [this!]
	lpMsg [LPMSG!]
...
UI_FilterDataObject!: alias function! [
	this [this!]
